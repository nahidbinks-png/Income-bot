...
def get_reply_keyboard():
    ...
    # নতুন লোকেশন অপশন যুক্ত করা হয়েছে
    markup.row(
...
# --- লোকেশন মেসেজ প্রসেস করার হ্যান্ডলার ---
...
def handle_location(message):
    ...
    # সুপাবেজে ডাটা স্টোর করতে চাইলে নিচের ব্লক সার্ভিস অনুযায়ী মডিফাই করতে পারেন
    try:
        supabase.table("users").update({
            "last_lat": lat,
            "last_lon": lon
...
# --- লাইভ লোকেশন আপডেট প্রসেস করার হ্যান্ডলার ---
...
def handle_edited_location(message):
    ...
    # ইউজারের লাইভ লোকেশন অন থাকলে প্রতি আপডেট পাওয়া যাবে
    print(f"Live Location Updated for {user_id}: {lat}, {lon}")
...
if __name__ == '__main__':
    ...
    print("Bot is running with Flask, Supabase & Location handling...")
